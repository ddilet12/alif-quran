...
const formats = [
  {
    ...
    items: [
      "Үйден оқу",
      "Zoom арқылы тікелей сабақ (аптасына 2 рет)",
      "Видео сабақтар",
      "Электронды материалдар",
      "Тапсырмалар",
      "Ұстазбен WhatsApp арқылы кері байланыс",
    ],
    cta: "Сабаққа жазылу",
  },
  {
    ...
    title: "Офлайн оқу",
    price: "50 000 ₸",
    note: "Zoom арқылы қосылу мүмкіндігімен",
    items: [
      "Ұстазбен тікелей сабақ",
      "Келе алмасаңыз — Zoom арқылы қосыласыз",
      "Практикалық оқу",
      "Қателерді түзету",
      "Жеке кері байланыс",
    ],
