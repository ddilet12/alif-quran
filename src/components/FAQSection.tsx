...
const faqs = [
  ...
  {
    q: "Офлайн оқу бар ма?",
    a: "Иә. Офлайн форматта Әліппе курсы — 50 000 ₸. Ұстазбен тікелей сабақ, практикалық оқу және жеке кері байланыс. Қаласаңыз, офлайн топқа Zoom арқылы қосылуға да болады.",
  },
  {
    q: "Әліппе курсының бағасы қанша?",
    a: "Барлық курстар — 50 000 ₸ (Құран хатымы — айына 50 000 ₸). Онлайн да, офлайн да Zoom арқылы қосылуға болады.",
  },
  {
